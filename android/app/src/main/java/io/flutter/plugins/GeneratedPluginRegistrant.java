...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.flutter_colors_border.FlutterColorsBorderPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_colors_border, com.example.flutter_colors_border.FlutterColorsBorderPlugin", e);
    }
    try {
