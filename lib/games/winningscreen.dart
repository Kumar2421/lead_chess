  ...
  void _showRejectionDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => PlayOnline(bettingAmount: '', userData: {}))),
            child: Text("OK"),
          ),
        ],
      ),
      ...
      body: isDataLoaded
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/winning_background.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => PlayOnline(bettingAmount: '', userData: {})),
                  );
                },
                child: Text('exit'),
              ),
