...
class _SignInState extends State<SignIn> {
  ...
  //  var sessionToken = generateUniqueToken();
   // final url = Uri.parse("https://leadproduct.000webhostapp.com/chessApi/login.php");
    final url = Uri.parse('https://schmidivan.com/Esakki/ChessGame/login');
    try {
              ...
              children: <Widget>[
                ...
                Padding(
                  padding:  EdgeInsets.only(top: screenHeight/20),
                        child: Image(image: const AssetImage('assets/LC-logo1.png'),height: screenHeight/15,width: screenWidth/8,),
                    ),
