...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  Future<void> resetPassword(String email, String newPassword) async {
    ...
    final url = Uri.parse('https://schmidivan.com/Esakki/ChessGame/forgetpassword');
    try {
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  width: screenWidth/1,
                  child: const Text('Forget Password',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Colors.white),),
                ),
              ),
              Padding(
