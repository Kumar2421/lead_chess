           ...
           // SizedBox(height: screenHeight/20,),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                width: screenWidth/4,
                // color: Colors.pink,
                child: const Text('Login',style: TextStyle(color:Colors.white,fontSize: 30,fontWeight: FontWeight.bold),),
              ),
            ),
            Padding(
              ...
              child: Container(
                alignment: Alignment.topLeft,
                child: const Text('Enter your phone number',style: TextStyle(color:Colors.white,fontSize: 12,fontWeight: FontWeight.bold),),
              ),
            ),
            Padding(
